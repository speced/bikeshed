...
* **Translations** indicates translations of the document. It must contain a comma-separated list of locations, each of which consists of the name of the location followed by the url.
