...
def parse(string):
    ...
    these are put on the same line as the command name,
    like:
        Choice: 0
            Terminal: foo
            Terminal: bar
