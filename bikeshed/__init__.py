...
class CSSSpec(object):
    ...
    def __init__(self, inputFilename, paragraphMode="markdown"):
        ...
        self.testSuites = json.load(
                            config.retrieveCachedFile(cacheLocation=config.scriptPath+"/spec-data/test-suites.json", type="test suite list", quiet=True))
...
def addSpecMetadataSection(doc):
    ...
    if doc.md.mailingList:
        span = E.span(
            E.a({"href":"mailto:"+doc.md.mailingList+"?subject=["+mac['shortname']+"]%20feedback"}, doc.md.mailingList),
            " with subject line “",
            E.kbd(
                "[",
                mac['shortname'],
