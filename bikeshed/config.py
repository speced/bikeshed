...
megaGroups = {
    "w3c": frozenset(["csswg", "dap", "fxtf", "geolocation", "houdini", "html", "i18n", "ricg", "svg", "texttracks", "uievents", "web-bluetooth-cg", "webappsec", "webauthn", "webperf", "webplatform", "webspecs", "webvr", "wicg"]),
    "iso": frozenset(["wg21"]),
