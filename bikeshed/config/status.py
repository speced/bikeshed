...
megaGroups = {
    "w3c": frozenset(["act-framework", "audiowg", "csswg", "dap", "fxtf", "fxtf-csswg", "geolocation", "houdini", "html", "i18n", "immersivewebwg", "mediacapture", "processcg", "ricg", "sacg", "serviceworkers", "svg", "texttracks", "uievents", "webapps", "wasm", "web-bluetooth-cg", "webappsec", "webauthn", "webml", "web-payments", "webperf", "webplatform", "webrtc", "webspecs", "webvr", "wicg"]),
